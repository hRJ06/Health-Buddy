...
const { signup, login, resetPasswordToken, resetPassword, getDoctorDetails, getDoctors, getAppointments, updateProfilePicture, addSlot } = require('../controller/Doctor');
